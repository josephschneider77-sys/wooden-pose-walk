...
- **Walk to the beret, sunglasses, or shoes** — put them on (tap a worn item to take it off)
...
This branch is a small **find-and-wear** experiment (beret, sunglasses, shoes) kept off `main`. One item per slot; picking a second hat, glasses, or pair of shoes drops the first back on the grass.
