...
export class Bazaar {
  ...
  readonly vaultDiscs: Disc[] = [];
  readonly hallDiscs: Disc[] = [];
  ...
  constructor() {
    ...
    this.hallDiscs.push({ x: 2.55, z: -1.45, r: 1.05 });
  ...
  private buildVault(): void {
    ...
    this.vault.add(well);
    this.vaultDiscs.push({ x: 0, z: 0, r: 0.78 });
    ...
    for (const [x, z] of spots) {
      ...
      this.vaultDiscs.push({ x, z, r: 0.36 });
    }
  }
}
